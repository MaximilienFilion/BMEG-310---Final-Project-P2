...
age_info$age_group <- ifelse(age_info$age == "0-79", "under80", "80plus")
age_info$age_group <- factor(age_info$age_group, levels = c("under80", "80plus"))
...
# Run DESeq2
dds <- DESeq(dds)
res <- results(dds, contrast = c("age_group", "80plus", "under80"))
